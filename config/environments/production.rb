...
Rails.application.configure do
  ...
  # has been made available in either ENV["RAILS_MASTER_KEY"]
  ...
  # Enable serving of images, stylesheets,
  # and JavaScripts from an asset server.
  ...
  # Store uploaded files on
  # the local file system (see config/storage.yml for options)
  ...
  # for Active Job (and separate queues per environment)
  # config.active_job.queue_adapter     = :resque
  # config.active_job.queue_name_prefix = "banking_app_#{Rails.env}"
