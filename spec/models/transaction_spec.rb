...
RSpec.describe Transaction, type: :model do
  context 'Transaction validation' do
    ...
    it 'is invalid without transaction type' do
      expect(
        FactoryBot.build(:transaction, transaction_type: nil)
      ).to be_invalid
    end
    ...
    it 'has valid transaction_type' do
      expect(
        FactoryBot.build(:transaction, transaction_type: 'withdraw')
      ).to be_valid
    end
    it 'has valid transaction_type' do
      expect(
        FactoryBot.build(:transaction, transaction_type: 'deposit')
      ).to be_valid
    end
